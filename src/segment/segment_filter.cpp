...
ymse::vec2f segment_filter::get_head_pos() const { return s->get_head_pos(); }
ymse::vec2f segment_filter::get_head_direction() const { return s->get_head_direction(); }
ymse::vec2f segment_filter::get_tail_pos() const { return s->get_tail_pos(); }
ymse::vec2f segment_filter::get_tail_direction() const { return s->get_tail_direction(); }
